        ...
        public User login()
    {
        ...
        for (int i = 0; i < objects.Length; i++)
        {
            ...
            try
            {
                ...
                Soa.Client.Model.ModelObject[] objectss = { owner };
                String[] attributes = {"user_name" };
                dmService.GetProperties(objectss, attributes);
                Console.WriteLine("-----------------------------------------------------------------");
                Console.WriteLine(name + "\t" + owner.GetProperty("user_name").StringValue + "\t" + lastModified.ToString());
            }
        ...
        public static void ResponseAttributer(ModelObject[] objects)
        {
            if (objects == null)
                return;
